...
The `PUT` method binds the resource pointed to by the given URI(s) to the associtation resource (see Supported Media Types). It adds a elements to the collection.
